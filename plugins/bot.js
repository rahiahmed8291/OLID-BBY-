...
module.exports = {
  ...
  start: async function ({ api, event, args }) {
    ...
    if (!usermsg) {
      const greetings = [
  "আহ শুনা আমার আলভি অলিদ বস এ তোমার অলিতে গলিতে উম্মাহ দেয় 😇😘",
  "কি গো সোনা আমাকে ডাকছ কেনো আমারে না ডেকে আমার বস আলবি অলিদ রে ডাক ☹️",
  "বার বার আমাকে ডাকস কেন ছুদাওলির ফুয়া 😡",
  "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো আমার না আমার আলবি অলিদ বস এর 🥱",
  "হুম জান আমার বস আলবি অলিদ তোমার অইখানে উম্মমাহ দেয় 😷😘",
